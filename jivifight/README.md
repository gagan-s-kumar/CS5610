 ...
 * Create a new Linux user account, "jivifight".
 * Add a nginx config for the new site. See "jivifight.nginx" for an example.

As the new user:

 * Install NodeJS through NVM.
 * Check out this git repository to ~/src/jivifight
